...
class Force:
    ...
    def _calculate_derived_coefficients(self) -> "Force":
        ...
        b2 = (3 * self.t1 * (1 + 0.5 * self.x1) - 
              self.t2 * (1 + 0.5 * self.x2)) / 16
        b2p = (3 * self.t1 * (0.5 + self.x1) + 
               self.t2 * (0.5 + self.x2)) / 16
...
BUILTIN_FORCES = {
    "SLy4": {
        ...
        "t0": -2488.91, "t1": 486.82, "t2": -546.39, "t3": 13777.0, "t4": 0.0,
        "x0": 0.834, "x1": -0.344, "x2": -1.0, "x3": 1.354,
        "b4p": 123.0, "power": 1.0/6.0,
    },
    "SkM*": {
        "ex": 1, "zpe": 0,
        "h2m": [20.73553, 20.73553],
        "t0": -2645.0, "t1": 410.0, "t2": -135.0, "t3": 15595.0, "t4": 0.0,
        "x0": 0.09, "x1": 0.0, "x2": 0.0, "x3": 0.0,
        "b4p": 130.0, "power": 1.0/6.0,
    },
}
